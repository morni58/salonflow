    ...
    return (
      <section id="portfolio" data-anchor-section className="bg-brand-900 py-16 text-white md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif mb-4 text-center text-3xl font-semibold md:mb-6 md:text-4xl lg:text-5xl">
            Портфолио
          </h2>
  ...
  return (
    <section id="portfolio" data-anchor-section className="bg-brand-900 py-16 text-white md:py-20">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <h2 className="font-serif mb-4 text-3xl font-semibold md:mb-6 md:text-4xl lg:text-5xl">Портфолио</h2>
